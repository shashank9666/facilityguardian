...
export const USERS: User[] = [
  CURRENT_USER,
  { id:"U002",name:"Priya Nair",email:"priya@fmnexus.in",role:"manager",department:"Operations",active:true,createdAt:"2024-02-01" },
  { id:"U003",name:"Rahul Mehta",email:"rahul@fmnexus.in",role:"technician",department:"Maintenance",active:true,createdAt:"2024-02-15" },
  { id:"U004",name:"Sneha Iyer",email:"sneha@fmnexus.in",role:"technician",department:"Electrical",active:true,createdAt:"2024-03-01" },
  { id:"U005",name:"Karan Gupta",email:"karan@fmnexus.in",role:"viewer",department:"HR",active:false,createdAt:"2024-03-10" },
];
...
export const WORK_ORDERS: WorkOrder[] = [
  {
    ...
    createdAt:"2026-03-28T09:00:00",dueDate:"2026-04-02",
  ...
  },
  {
    ...
    createdAt:"2026-03-25T11:00:00",dueDate:"2026-04-05",
  ...
  },
  {
    ...
    createdAt:"2026-03-31T07:30:00",dueDate:"2026-04-01",
  ...
  },
  {
    ...
    createdAt:"2026-03-20T09:00:00",dueDate:"2026-03-25",completedAt:"2026-03-24T16:00:00",
  ...
  },
  {
    ...
    createdAt:"2026-04-01T08:00:00",dueDate:"2026-04-07",
...
export const SPACES: Space[] = [
  // HQ Campus
  {id:"S001",site:"HQ Campus",name:"Main Lobby",type:"Conference",floor:"G",building:"Block A",capacity:50,occupied:35,status:"occupied",lastInspection:"2026-03-25",area:1200},
  {id:"S002",site:"HQ Campus",name:"Conference Hall A",type:"Conference",floor:"1",building:"Block A",capacity:20,occupied:0,status:"available",lastInspection:"2026-03-15",area:450},
  {id:"S003",site:"HQ Campus",name:"Open Office 1A",type:"Workstation",floor:"1",building:"Block A",capacity:80,occupied:72,status:"occupied",lastInspection:"2026-03-20",area:2000},
  {id:"S004",site:"HQ Campus",name:"Board Room",type:"Conference",floor:"5",building:"Block A",capacity:30,occupied:0,status:"reserved",lastInspection:"2026-02-10",area:600},
  {id:"S005",site:"HQ Campus",name:"Server Room",type:"Utility",floor:"3",building:"Block A",capacity:5,occupied:2,status:"maintenance",lastInspection:"2026-03-28",area:200},
  {id:"S006",site:"HQ Campus",name:"Cafeteria",type:"Cafeteria",floor:"G",building:"Block B",capacity:100,occupied:60,status:"occupied",lastInspection:"2026-03-25",area:3000},
  {id:"S007",site:"HQ Campus",name:"Gym & Wellness",type:"Recreation",floor:"G",building:"Block B",capacity:40,occupied:12,status:"available",lastInspection:"2026-03-18",area:1500},
  {id:"S008",site:"HQ Campus",name:"Parking Level B1",type:"Parking",floor:"B1",building:"Block A",capacity:120,occupied:98,status:"occupied",lastInspection:"2026-03-10",area:5000},
  // North Site
  {id:"S009",site:"North Site",name:"Reception",type:"Conference",floor:"G",building:"Tower 1",capacity:15,occupied:0,status:"available",lastInspection:"2026-03-12",area:300},
  {id:"S010",site:"North Site",name:"Training Room 1",type:"Conference",floor:"2",building:"Tower 1",capacity:40,occupied:32,status:"occupied",lastInspection:"2026-03-18",area:800},
  {id:"S011",site:"North Site",name:"Open Office 2A",type:"Workstation",floor:"2",building:"Tower 1",capacity:60,occupied:55,status:"occupied",lastInspection:"2026-03-20",area:1400},
  {id:"S012",site:"North Site",name:"Storage Room N1",type:"Storage",floor:"B1",building:"Tower 1",capacity:0,occupied:0,status:"available",lastInspection:"2026-02-28",area:400},
  {id:"S013",site:"North Site",name:"Electrical Room",type:"Utility",floor:"B1",building:"Tower 1",capacity:2,occupied:1,status:"maintenance",lastInspection:"2026-03-05",area:150},
  // South Campus
  {id:"S014",site:"South Campus",name:"Auditorium",type:"Conference",floor:"G",building:"Wing A",capacity:300,occupied:0,status:"available",lastInspection:"2026-03-08",area:8000},
  {id:"S015",site:"South Campus",name:"Labs Block",type:"Workstation",floor:"1",building:"Wing B",capacity:50,occupied:45,status:"occupied",lastInspection:"2026-03-22",area:2200},
  {id:"S016",site:"South Campus",name:"Visitor Parking",type:"Parking",floor:"G",building:"Wing A",capacity:80,occupied:52,status:"occupied",lastInspection:"2026-03-14",area:3500},
  {id:"S017",site:"South Campus",name:"Canteen",type:"Cafeteria",floor:"G",building:"Wing B",capacity:80,occupied:35,status:"occupied",lastInspection:"2026-03-19",area:1800},
];
...
export const INVENTORY: InventoryItem[] = [
  {id:"INV001",code:"SPR-HVAC-F01",name:"HVAC Air Filter (G4)",category:"HVAC Spares",unit:"Pcs",quantity:8,minQuantity:4,maxQuantity:20,status:"in_stock",location:"Store A-1",supplierName:"SwiftTech HVAC",unitCost:850,lastRestocked:"2026-02-01"},
  {id:"INV002",code:"SPR-ELEC-B01",name:"MCB 32A (Schneider)",category:"Electrical",unit:"Pcs",quantity:2,minQuantity:5,maxQuantity:20,status:"low_stock",location:"Store A-2",supplierName:"ElectroHub",unitCost:420,lastRestocked:"2026-01-15"},
  {id:"INV003",code:"CLN-001",name:"Floor Cleaning Solution (5L)",category:"Housekeeping",unit:"Can",quantity:0,minQuantity:3,maxQuantity:15,status:"out_of_stock",location:"Housekeeping Store",supplierName:"CleanPro",unitCost:650,lastRestocked:"2026-03-01"},
  {id:"INV004",code:"SPR-PUMP-B01",name:"Pump Bearing 6205",category:"Plumbing",unit:"Pcs",quantity:3,minQuantity:2,maxQuantity:10,status:"in_stock",location:"Store B-1",supplierName:"Kirloskar Spares",unitCost:1200,lastRestocked:"2026-03-20"},
  {id:"INV005",code:"LIGHT-LED-001",name:"LED Tube 18W (Philips)",category:"Electrical",unit:"Pcs",quantity:24,minQuantity:10,maxQuantity:60,status:"in_stock",location:"Store A-2",supplierName:"ElectroHub",unitCost:280,lastRestocked:"2026-03-15"},
  {id:"INV006",code:"SPR-FIRE-001",name:"Fire Extinguisher ABC 6KG",category:"Fire Safety",unit:"Pcs",quantity:4,minQuantity:5,maxQuantity:20,status:"low_stock",location:"Store B-2",supplierName:"Safeguard Fire",unitCost:2200,lastRestocked:"2026-01-10"},
];
