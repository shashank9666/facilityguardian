export const titleMap: Record<string, { title: string; subtitle: string }> = {
  ...
  checklists:     { title: "Checklists & SOPs",     subtitle: "Facility inspections & SOP audits" },
  ...
  notifications:  { title: "Alert Center",          subtitle: "System notifications & facility alerts" }
};
